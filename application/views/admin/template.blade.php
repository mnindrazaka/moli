...
<html class="no-js" lang="en">
    <head>
        ...
        <title> Admin | Moli </title>
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <link rel="apple-touch-icon" href="apple-touch-icon.png">
        <!-- Place favicon.ico in the root directory -->
        <link rel="stylesheet" href="{{ base_url('assets/vendors/modular-admin/css/') }}vendor.css">
        ...
        <script>
            ...
            if (themeName)
            {
                document.write('<link rel="stylesheet" id="theme-style" href="{{ base_url('assets/vendors/modular-admin/css/') }}app-' + themeName + '.css">');
            }
            else
            {
                document.write('<link rel="stylesheet" id="theme-style" href="{{ base_url('assets/vendors/modular-admin/css/') }}app.css">');
            }
        </script>
        @yield('header')
    </head>
    <body>
        ...
        <script src="{{ base_url('assets/vendors/modular-admin/js/') }}vendor.js"></script>
        <script src="{{ base_url('assets/vendors/modular-admin/js/') }}app.js"></script>
        @yield('script')
    </body>
</html>
