...
<div class="">
  <h2 class="title">Gold <img src="{{ base_url() }}assets/vendors/icon/gold-shield.png" alt="Card image cap" style="width: 27px; height: 33px;" alt=""></h2>
  ...
  <form action="{{ base_url('tokoSaya/Toko/update/' . $id_toko) }}" method="post">
    ...
    <button type="submit" class="btn btn-outline-warning">Upgrade</button>
  </form>
</div>
@endsection
