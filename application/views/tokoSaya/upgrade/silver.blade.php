...
<div class="">
  <h2 class="title">Silver <img src="{{ base_url() }}assets/vendors/icon/silver-shield.png" alt="Card image cap" style="width: 27px; height: 33px;" alt=""></h2>
  ...
  <form action="{{ base_url('tokoSaya/Toko/update/' . $id_toko) }}" method="post">
    <input type="hidden" name="id_jenis_toko" value="2">
    <button type="submit" class="btn btn-outline-primary">Upgrade</button>
  </form>
</div>
@endsection
